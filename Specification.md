...
- Main WhatsApp channels, including documentation on how to join. ✅ (Demo only)
  - https://chat.whatsapp.com/<invite_code>
  - https://chat.whatsapp.com/AbCdEfGhIjK1LmN2OpQrSt
  
- (If possible) Summaries of the latest posts from all channels. (Not feasible)
...
List of ride leaders and their emergency contact details. (Not yet implemented)
Main website links, including blog and newsletter. (https://www.sanfairyanncc.co.uk) ✅
Information about the Annual General Meeting. (Not yet implemented)
Recommended cycle repair shops. (Not yet implemented)
Links to your profile on Strava, Garmin Connect, etc. (Partially present, not user-specific)
Instructions on how to renew club membership. (Not yet implemented)

### Additional Features
Use the same theme colors as the main website. ✅
Support desktop devices as well as mobile. ✅
Allow users to link to their preferred routing app (e.g., Ride with GPS, Garmin). (Not yet implemented)
...
Ability to set up reminders for upcoming rides, with summaries and weather forecasts, displayed on the dashboard only. (Not yet implemented)
...
- Change the WhatsApp links to actual WhatsApp links.
- Possibly purchase an actual domain instead of using:
  - https://polite-sand-0eb4b4703.3.azurestaticapps.net/
- Possibly create an Android and iPhone App to publish into the relevant stores. (Utilizing RazorClassLibrary and Blazor Hybrid technology)
- WhatsApp summaries (not feasible)
...
- Links to your profile on Strava, Garmin Connect, etc. (user-specific)
- Instructions on how to renew club membership
- Poll features similar to WhatsApp
